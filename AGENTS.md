...
- Conserva las imágenes propias de cada página; no reutilices una imagen entre sitios si puede dar a entender que representan el mismo servicio. Las imágenes de hero deben cargar, conservar un encuadre adecuado al `object-fit: cover` y tener dimensiones declaradas.
